...
🟡 **M5+**: FRESH alert rate (11.1%) is 2.3× the overall rate (4.8%) — score distribution shift detected
...
|--------|------|--------|--------|---------|--------|----------|------|--------|------|-----|----------|
|    FRESH |   54 |   12.0 | 18.5% | 0.505 | 0.2 |       50 | 80.0% |  30.8% | 1.5× | 8.3% |   0.5200 |
|       OK |   26 |   36.7 | 3.9% | 0.401 | 0.0 |       26 | 100.0% |  25.0% | 6.5× | 0.0% |   0.1538 |
| DEGRADED |   44 |  116.4 | 11.4% | 0.423 | 0.1 |       44 | 0.0% |   0.0% |    - | 15.2% |   0.2500 |
|      ALL |  124 |   54.2 | 12.9% | 0.454 | 0.1 |      120 | 56.2% |  21.9% | 1.6× | 8.9% |   0.3417 |

### M5+

| Bucket | Days | Lag(h) | Alert% | MaxProb | AR/day | Verified | Prec | Recall | Lift | FAR | BaseRate |
|--------|------|--------|--------|---------|--------|----------|------|--------|------|-----|----------|
|    FRESH |   54 |   12.0 | 11.1% | 0.491 | 0.1 |       50 | 66.7% |  36.4% | 3.0× | 5.1% |   0.2200 |
|       OK |   26 |   36.7 | 0.0% | 0.334 | 0.0 |       26 |    - |      - |    - | 0.0% |   0.0000 |
| DEGRADED |   44 |  116.4 | 0.0% | 0.351 | 0.0 |       44 |    - |   0.0% |    - | 0.0% |   0.0682 |
|      ALL |  124 |   54.2 | 4.8% | 0.408 | 0.1 |      120 | 66.7% |  28.6% | 5.7× | 1.9% |   0.1167 |

### X+

| Bucket | Days | Lag(h) | Alert% | MaxProb | AR/day | Verified | Prec | Recall | Lift | FAR | BaseRate |
|--------|------|--------|--------|---------|--------|----------|------|--------|------|-----|----------|
|    FRESH |   54 |   12.0 | 11.1% | 0.353 | 0.1 |       50 | 16.7% |  20.0% | 1.7× | 11.1% |   0.1000 |
|       OK |   26 |   36.7 | 7.7% | 0.317 | 0.1 |       26 | 0.0% |      - |    - | 7.7% |   0.0000 |
| DEGRADED |   44 |  116.4 | 6.8% | 0.310 | 0.1 |       44 | 0.0% |   0.0% |    - | 7.0% |   0.0227 |
|      ALL |  124 |   54.2 | 8.9% | 0.330 | 0.1 |      120 | 9.1% |  16.7% | 1.8× | 8.8% |   0.0500 |
...
| Bucket | Days | Lag(h) | Alert% | MaxProb | AR/day | Verified | Prec | Recall | Lift | FAR | BaseRate |
|--------|------|--------|--------|---------|--------|----------|------|--------|------|-----|----------|
|    FRESH |   17 |   10.2 | 35.3% | 0.608 | 0.5 |       13 | 83.3% |  55.6% | 1.2× | 25.0% |   0.6923 |
|       OK |    4 |   35.9 | 0.0% | 0.372 | 0.0 |        4 |    - |   0.0% |    - | 0.0% |   0.2500 |
| DEGRADED |   10 |  111.0 | 10.0% | 0.515 | 0.1 |       10 | 0.0% |   0.0% |    - | 12.5% |   0.2000 |
|      ALL |   31 |   46.0 | 22.6% | 0.547 | 0.3 |       27 | 71.4% |  41.7% | 1.6× | 13.3% |   0.4444 |

### M5+

| Bucket | Days | Lag(h) | Alert% | MaxProb | AR/day | Verified | Prec | Recall | Lift | FAR | BaseRate |
|--------|------|--------|--------|---------|--------|----------|------|--------|------|-----|----------|
|    FRESH |   17 |   10.2 | 29.4% | 0.597 | 0.3 |       13 | 60.0% |  50.0% | 1.3× | 28.6% |   0.4615 |
...
| Bucket | Days | Lag(h) | Alert% | MaxProb | AR/day | Verified | Prec | Recall | Lift | FAR | BaseRate |
|--------|------|--------|--------|---------|--------|----------|------|--------|------|-----|----------|
|    FRESH |   17 |   10.2 | 23.5% | 0.520 | 0.2 |       13 | 25.0% |  50.0% | 1.6× | 27.3% |   0.1538 |
