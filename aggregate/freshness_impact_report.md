...
|--------|------|--------|--------|---------|--------|----------|------|--------|------|-----|----------|
|    FRESH |   15 |   13.1 | 0.0% | 0.410 | 0.0 |       11 |    - |   0.0% |    - | 0.0% |   0.4545 |
|       OK |    8 |   35.9 | 0.0% | 0.417 | 0.0 |        8 |    - |   0.0% |    - | 0.0% |   0.2500 |
| DEGRADED |    4 |   86.0 | 50.0% | 0.425 | 0.5 |        4 | 0.0% |   0.0% |    - | 66.7% |   0.2500 |
|      ALL |   27 |   30.6 | 7.4% | 0.414 | 0.1 |       23 | 0.0% |   0.0% |    - | 13.3% |   0.3478 |

### M5+

| Bucket | Days | Lag(h) | Alert% | MaxProb | AR/day | Verified | Prec | Recall | Lift | FAR | BaseRate |
|--------|------|--------|--------|---------|--------|----------|------|--------|------|-----|----------|
|    FRESH |   15 |   13.1 | 0.0% | 0.393 | 0.0 |       11 |    - |   0.0% |    - | 0.0% |   0.0909 |
|       OK |    8 |   35.9 | 0.0% | 0.379 | 0.0 |        8 |    - |      - |    - | 0.0% |   0.0000 |
| DEGRADED |    4 |   86.0 | 0.0% | 0.336 | 0.0 |        4 |    - |      - |    - | 0.0% |   0.0000 |
|      ALL |   27 |   30.6 | 0.0% | 0.380 | 0.0 |       23 |    - |   0.0% |    - | 0.0% |   0.0435 |

### X+

| Bucket | Days | Lag(h) | Alert% | MaxProb | AR/day | Verified | Prec | Recall | Lift | FAR | BaseRate |
|--------|------|--------|--------|---------|--------|----------|------|--------|------|-----|----------|
|    FRESH |   15 |   13.1 | 6.7% | 0.245 | 0.1 |       11 |    - |   0.0% |    - | 0.0% |   0.0909 |
|       OK |    8 |   35.9 | 0.0% | 0.346 | 0.0 |        8 |    - |      - |    - | 0.0% |   0.0000 |
| DEGRADED |    4 |   86.0 | 25.0% | 0.467 | 0.2 |        4 | 0.0% |      - |    - | 25.0% |   0.0000 |
|      ALL |   27 |   30.6 | 7.4% | 0.308 | 0.1 |       23 | 0.0% |   0.0% |    - | 4.5% |   0.0435 |
