...
🟡 **M5+**: FRESH alert rate (10.8%) is 2.5× the overall rate (4.4%) — score distribution shift detected
...
|--------|------|--------|--------|---------|--------|----------|------|--------|------|-----|----------|
|    FRESH |   65 |   12.5 | 20.0% | 0.514 | 0.2 |       63 | 81.8% |  31.0% | 1.8× | 5.9% |   0.4603 |
|       OK |   34 |   37.0 | 8.8% | 0.411 | 0.1 |       33 | 50.0% |  25.0% | 4.1× | 3.5% |   0.1212 |
| DEGRADED |   61 |  118.1 | 8.2% | 0.406 | 0.1 |       61 | 0.0% |   0.0% |    - | 10.6% |   0.2295 |
|      ALL |  160 |   58.0 | 13.1% | 0.451 | 0.1 |      157 | 55.6% |  21.3% | 1.9× | 7.3% |   0.2994 |

### M5+

| Bucket | Days | Lag(h) | Alert% | MaxProb | AR/day | Verified | Prec | Recall | Lift | FAR | BaseRate |
|--------|------|--------|--------|---------|--------|----------|------|--------|------|-----|----------|
|    FRESH |   65 |   12.5 | 10.8% | 0.506 | 0.1 |       63 | 57.1% |  36.4% | 3.3× | 5.8% |   0.1746 |
|       OK |   34 |   37.0 | 0.0% | 0.344 | 0.0 |       33 |    - |      - |    - | 0.0% |   0.0000 |
| DEGRADED |   61 |  118.1 | 0.0% | 0.337 | 0.0 |       61 |    - |   0.0% |    - | 0.0% |   0.0492 |
|      ALL |  160 |   58.0 | 4.4% | 0.407 | 0.0 |      157 | 57.1% |  28.6% | 6.4× | 2.1% |   0.0892 |

### X+

| Bucket | Days | Lag(h) | Alert% | MaxProb | AR/day | Verified | Prec | Recall | Lift | FAR | BaseRate |
|--------|------|--------|--------|---------|--------|----------|------|--------|------|-----|----------|
|    FRESH |   65 |   12.5 | 9.2% | 0.365 | 0.1 |       63 | 16.7% |  20.0% | 2.1× | 8.6% |   0.0794 |
|       OK |   34 |   37.0 | 5.9% | 0.315 | 0.1 |       33 | 0.0% |      - |    - | 6.1% |   0.0000 |
| DEGRADED |   61 |  118.1 | 4.9% | 0.291 | 0.1 |       61 | 0.0% |   0.0% |    - | 5.0% |   0.0164 |
|      ALL |  160 |   58.0 | 6.9% | 0.326 | 0.1 |      157 | 9.1% |  16.7% | 2.4× | 6.6% |   0.0382 |
...
| Bucket | Days | Lag(h) | Alert% | MaxProb | AR/day | Verified | Prec | Recall | Lift | FAR | BaseRate |
|--------|------|--------|--------|---------|--------|----------|------|--------|------|-----|----------|
|    FRESH |    9 |   14.3 | 33.3% | 0.600 | 0.4 |        7 | 100.0% |  50.0% | 3.5× | 0.0% |   0.2857 |
|       OK |    6 |   35.9 | 33.3% | 0.516 | 0.3 |        5 | 0.0% |      - |    - | 20.0% |   0.0000 |
| DEGRADED |   13 |  129.1 | 0.0% | 0.389 | 0.0 |       13 |    - |   0.0% |    - | 0.0% |   0.1538 |
|      ALL |   28 |   72.2 | 17.9% | 0.484 | 0.2 |       25 | 50.0% |  25.0% | 3.1× | 4.8% |   0.1600 |

### M5+

| Bucket | Days | Lag(h) | Alert% | MaxProb | AR/day | Verified | Prec | Recall | Lift | FAR | BaseRate |
|--------|------|--------|--------|---------|--------|----------|------|--------|------|-----|----------|
|    FRESH |    9 |   14.3 | 11.1% | 0.645 | 0.1 |        7 | 0.0% |      - |    - | 14.3% |   0.0000 |
|       OK |    6 |   35.9 | 0.0% | 0.452 | 0.0 |        5 |    - |      - |    - | 0.0% |   0.0000 |
| DEGRADED |   13 |  129.1 | 0.0% | 0.346 | 0.0 |       13 |    - |      - |    - | 0.0% |   0.0000 |
|      ALL |   28 |   72.2 | 3.6% | 0.465 | 0.0 |       25 | 0.0% |      - |    - | 4.0% |   0.0000 |

### X+

| Bucket | Days | Lag(h) | Alert% | MaxProb | AR/day | Verified | Prec | Recall | Lift | FAR | BaseRate |
|--------|------|--------|--------|---------|--------|----------|------|--------|------|-----|----------|
|    FRESH |    9 |   14.3 | 0.0% | 0.477 | 0.0 |        7 |    - |      - |    - | 0.0% |   0.0000 |
|       OK |    6 |   35.9 | 0.0% | 0.359 | 0.0 |        5 |    - |      - |    - | 0.0% |   0.0000 |
| DEGRADED |   13 |  129.1 | 0.0% | 0.248 | 0.0 |       13 |    - |      - |    - | 0.0% |   0.0000 |
|      ALL |   28 |   72.2 | 0.0% | 0.345 | 0.0 |       25 |    - |      - |    - | 0.0% |   0.0000 |
