...
| Bucket | Days | Lag(h) | Alert% | MaxProb | AR/day | Verified | Prec | Recall | Lift | FAR | BaseRate |
|--------|------|--------|--------|---------|--------|----------|------|--------|------|-----|----------|
|    FRESH |   11 |   11.0 | 9.1% | 0.427 | 0.1 |       10 |    - |   0.0% |    - | 0.0% |   0.5000 |
|       OK |    6 |   34.7 | 16.7% | 0.451 | 0.2 |        6 | 100.0% |  50.0% | 3.0× | 0.0% |   0.3333 |
| DEGRADED |   13 |  173.6 | 0.0% | 0.357 | 0.0 |       11 |    - |      - |    - | 0.0% |   0.0000 |
|      ALL |   30 |   86.2 | 6.7% | 0.401 | 0.1 |       27 | 100.0% |  14.3% | 3.9× | 0.0% |   0.2593 |

### M5+

| Bucket | Days | Lag(h) | Alert% | MaxProb | AR/day | Verified | Prec | Recall | Lift | FAR | BaseRate |
|--------|------|--------|--------|---------|--------|----------|------|--------|------|-----|----------|
|    FRESH |   11 |   11.0 | 0.0% | 0.428 | 0.0 |       10 |    - |   0.0% |    - | 0.0% |   0.2000 |
|       OK |    6 |   34.7 | 0.0% | 0.426 | 0.0 |        6 |    - |      - |    - | 0.0% |   0.0000 |
| DEGRADED |   13 |  173.6 | 0.0% | 0.322 | 0.0 |       11 |    - |      - |    - | 0.0% |   0.0000 |
|      ALL |   30 |   86.2 | 0.0% | 0.382 | 0.0 |       27 |    - |   0.0% |    - | 0.0% |   0.0741 |

### X+

| Bucket | Days | Lag(h) | Alert% | MaxProb | AR/day | Verified | Prec | Recall | Lift | FAR | BaseRate |
|--------|------|--------|--------|---------|--------|----------|------|--------|------|-----|----------|
|    FRESH |   11 |   11.0 | 9.1% | 0.272 | 0.1 |       10 | 0.0% |   0.0% |    - | 11.1% |   0.1000 |
|       OK |    6 |   34.7 | 16.7% | 0.371 | 0.2 |        6 | 0.0% |      - |    - | 16.7% |   0.0000 |
| DEGRADED |   13 |  173.6 | 0.0% | 0.177 | 0.0 |       11 |    - |      - |    - | 0.0% |   0.0000 |
|      ALL |   30 |   86.2 | 6.7% | 0.251 | 0.1 |       27 | 0.0% |   0.0% |    - | 7.7% |   0.0370 |
