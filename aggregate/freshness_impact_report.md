...
|--------|------|--------|--------|---------|--------|----------|------|--------|------|-----|----------|
|    FRESH |   15 |   13.1 | 0.0% | 0.410 | 0.0 |       14 |    - |   0.0% |    - | 0.0% |   0.5714 |
|       OK |    9 |   35.3 | 0.0% | 0.414 | 0.0 |        8 |    - |   0.0% |    - | 0.0% |   0.2500 |
| DEGRADED |    6 |   79.5 | 33.3% | 0.379 | 0.3 |        4 | 0.0% |   0.0% |    - | 66.7% |   0.2500 |
|      ALL |   30 |   33.0 | 6.7% | 0.405 | 0.1 |       26 | 0.0% |   0.0% |    - | 13.3% |   0.4231 |

### M5+

| Bucket | Days | Lag(h) | Alert% | MaxProb | AR/day | Verified | Prec | Recall | Lift | FAR | BaseRate |
|--------|------|--------|--------|---------|--------|----------|------|--------|------|-----|----------|
|    FRESH |   15 |   13.1 | 0.0% | 0.393 | 0.0 |       14 |    - |   0.0% |    - | 0.0% |   0.1429 |
|       OK |    9 |   35.3 | 0.0% | 0.386 | 0.0 |        8 |    - |      - |    - | 0.0% |   0.0000 |
| DEGRADED |    6 |   79.5 | 0.0% | 0.305 | 0.0 |        4 |    - |      - |    - | 0.0% |   0.0000 |
|      ALL |   30 |   33.0 | 0.0% | 0.373 | 0.0 |       26 |    - |   0.0% |    - | 0.0% |   0.0769 |

### X+

| Bucket | Days | Lag(h) | Alert% | MaxProb | AR/day | Verified | Prec | Recall | Lift | FAR | BaseRate |
|--------|------|--------|--------|---------|--------|----------|------|--------|------|-----|----------|
|    FRESH |   15 |   13.1 | 6.7% | 0.245 | 0.1 |       14 | 0.0% |   0.0% |    - | 7.7% |   0.0714 |
|       OK |    9 |   35.3 | 0.0% | 0.323 | 0.0 |        8 |    - |      - |    - | 0.0% |   0.0000 |
| DEGRADED |    6 |   79.5 | 16.7% | 0.344 | 0.2 |        4 | 0.0% |      - |    - | 25.0% |   0.0000 |
|      ALL |   30 |   33.0 | 6.7% | 0.288 | 0.1 |       26 | 0.0% |   0.0% |    - | 8.0% |   0.0385 |
