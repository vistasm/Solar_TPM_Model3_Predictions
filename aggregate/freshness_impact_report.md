...
|--------|------|--------|--------|---------|--------|----------|------|--------|------|-----|----------|
|    FRESH |   53 |   12.1 | 18.9% | 0.503 | 0.2 |       49 | 80.0% |  32.0% | 1.6× | 8.3% |   0.5102 |
|       OK |   26 |   36.7 | 3.9% | 0.401 | 0.0 |       26 | 100.0% |  25.0% | 6.5× | 0.0% |   0.1538 |
| DEGRADED |   44 |  116.4 | 11.4% | 0.423 | 0.1 |       44 | 0.0% |   0.0% |    - | 15.2% |   0.2500 |
|      ALL |  123 |   54.6 | 13.0% | 0.453 | 0.1 |      119 | 56.2% |  22.5% | 1.7× | 8.9% |   0.3361 |

### M5+

| Bucket | Days | Lag(h) | Alert% | MaxProb | AR/day | Verified | Prec | Recall | Lift | FAR | BaseRate |
|--------|------|--------|--------|---------|--------|----------|------|--------|------|-----|----------|
|    FRESH |   53 |   12.1 | 11.3% | 0.489 | 0.1 |       49 | 66.7% |  36.4% | 3.0× | 5.3% |   0.2245 |
|       OK |   26 |   36.7 | 0.0% | 0.334 | 0.0 |       26 |    - |      - |    - | 0.0% |   0.0000 |
| DEGRADED |   44 |  116.4 | 0.0% | 0.351 | 0.0 |       44 |    - |   0.0% |    - | 0.0% |   0.0682 |
|      ALL |  123 |   54.6 | 4.9% | 0.407 | 0.1 |      119 | 66.7% |  28.6% | 5.7× | 1.9% |   0.1176 |

### X+

| Bucket | Days | Lag(h) | Alert% | MaxProb | AR/day | Verified | Prec | Recall | Lift | FAR | BaseRate |
|--------|------|--------|--------|---------|--------|----------|------|--------|------|-----|----------|
|    FRESH |   53 |   12.1 | 11.3% | 0.352 | 0.1 |       49 | 16.7% |  20.0% | 1.6× | 11.4% |   0.1020 |
|       OK |   26 |   36.7 | 7.7% | 0.317 | 0.1 |       26 | 0.0% |      - |    - | 7.7% |   0.0000 |
| DEGRADED |   44 |  116.4 | 6.8% | 0.310 | 0.1 |       44 | 0.0% |   0.0% |    - | 7.0% |   0.0227 |
|      ALL |  123 |   54.6 | 8.9% | 0.330 | 0.1 |      119 | 9.1% |  16.7% | 1.8× | 8.8% |   0.0504 |
...
| Bucket | Days | Lag(h) | Alert% | MaxProb | AR/day | Verified | Prec | Recall | Lift | FAR | BaseRate |
|--------|------|--------|--------|---------|--------|----------|------|--------|------|-----|----------|
|    FRESH |   17 |   10.2 | 35.3% | 0.608 | 0.5 |       13 | 83.3% |  62.5% | 1.4× | 20.0% |   0.6154 |
|       OK |    4 |   35.9 | 0.0% | 0.372 | 0.0 |        4 |    - |   0.0% |    - | 0.0% |   0.2500 |
| DEGRADED |   10 |  111.0 | 10.0% | 0.515 | 0.1 |       10 | 0.0% |   0.0% |    - | 12.5% |   0.2000 |
|      ALL |   31 |   46.0 | 22.6% | 0.547 | 0.3 |       27 | 71.4% |  45.5% | 1.8× | 12.5% |   0.4074 |

### M5+

| Bucket | Days | Lag(h) | Alert% | MaxProb | AR/day | Verified | Prec | Recall | Lift | FAR | BaseRate |
|--------|------|--------|--------|---------|--------|----------|------|--------|------|-----|----------|
|    FRESH |   17 |   10.2 | 29.4% | 0.598 | 0.3 |       13 | 60.0% |  50.0% | 1.3× | 28.6% |   0.4615 |
|       OK |    4 |   35.9 | 0.0% | 0.331 | 0.0 |        4 |    - |      - |    - | 0.0% |   0.0000 |
| DEGRADED |   10 |  111.0 | 0.0% | 0.456 | 0.0 |       10 |    - |      - |    - | 0.0% |   0.0000 |
|      ALL |   31 |   46.0 | 16.1% | 0.518 | 0.2 |       27 | 60.0% |  50.0% | 2.7× | 9.5% |   0.2222 |

### X+

| Bucket | Days | Lag(h) | Alert% | MaxProb | AR/day | Verified | Prec | Recall | Lift | FAR | BaseRate |
|--------|------|--------|--------|---------|--------|----------|------|--------|------|-----|----------|
|    FRESH |   17 |   10.2 | 29.4% | 0.552 | 0.3 |       13 | 20.0% |  50.0% | 1.3× | 36.4% |   0.1538 |
|       OK |    4 |   35.9 | 0.0% | 0.283 | 0.0 |        4 |    - |      - |    - | 0.0% |   0.0000 |
| DEGRADED |   10 |  111.0 | 10.0% | 0.473 | 0.1 |       10 | 0.0% |      - |    - | 10.0% |   0.0000 |
|      ALL |   31 |   46.0 | 19.4% | 0.492 | 0.2 |       27 | 16.7% |  50.0% | 2.2× | 20.0% |   0.0741 |
